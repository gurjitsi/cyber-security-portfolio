...
### appsec-mobile/
- Enforcing Secure Transport in iOS with ATS [Dealing with App Transport Security in Xcode([https://gurjit.co/blogs/2026/understanding-certificates-in-cybersecurity.php](https://gurjit.co/blogs/2023/dealing-with-app-transport-security-in-xcode.php)))
